...
//┃LET LOVE LEAD
//┃
//┃WANNA RE UPLOAD GIVE A PROPER CREDIT
//┗━━━━━━━━━━━━━━━━━━━━━━━━━
//
...
break
	    ...
	    if (isBan) throw mess.ban
                ZimBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/4e12bdfc0fbcbe7d14930.jpg' }, caption: `*Hi Chomie ${m.pushName}*\n\n *Thanks for your support we appreciate you we dont need your money, support us by subscribing to our youtube channel* *DRIPS OFC:* 😐ලින්ක් එක නෑනෙ සහො😐 ` }, { quoted: m })
            }
            break            
            case 'chat': {
                if (!isCreator) throw mess.owner
  ...
  break
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
		            ...
		            let btn = [{
          urlButton: {
                  displayText: 'TELEGRAMhttps',
                  url: 'https://t.me/+rVqe2BqFcwkzOTVl'
          }
                            }]
...
╰━━━━━━━━━━━━━━━━━━╯`,
      ...
      const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `😐ලින්ක් එක නෑනෙ සහො😐` } }, { urlButton: { displayText: `GITHUB`, url : `https://github.com/zim-bot/zimbot-v3` } },
   {					
					quickReplyButton: {
						displayText: 'SPEED',
						id: 'ping'
